...
function createMarketShareChart(data) {
    return {
        ...
        xAxis: {
            type: 'category',
            data: data.xAxis || ['本公司', '竞争对手A', '竞争对手B', '竞争对手C', '其他']
        },
        yAxis: {
            type: 'value',
            name: '市场份额（%）',
...
function createCostStructureChart(data) {
    return {
        ...
        series: [{
            ...
            center: ['60%', '50%'],
            data: data.series || [
                {value: 10500, name: '核心组件'},
                {value: 3500, name: '原材料'},
                {value: 2000, name: '人工成本'},
                {value: 3000, name: '制造费用'},
                {value: 1000, name: '其他'}
            ],
            emphasis: {
                itemStyle: {
...
console.log('ECharts配置文件已加载 - 超充设备厂项目 - 玄金水墨主题');
